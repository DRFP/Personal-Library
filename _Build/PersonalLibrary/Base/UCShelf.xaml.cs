...
namespace Base {
	public partial class UCShelf : UserControl {
		...
		private void grdBase_MouseUp(object sender, MouseButtonEventArgs e) {
			onClick?.Invoke(this);
		}

		private void imgEdit_MouseUp(object sender, MouseButtonEventArgs e) {
			onClickEdit?.Invoke(this);
		}

		private void imgRemove_MouseUp(object sender, MouseButtonEventArgs e) {
